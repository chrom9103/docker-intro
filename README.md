...
Docker講習を開始する前に、Docker が何であり、なぜ必要なのかを理解しましょう。

### 0.1. Dockerが必要な理由

皆さんが開発したアプリケーションを他の人に渡したとき、こんなことが起きたことはありませんか？

- 「自分の環境では動くのに、相手の環境では動かない」
- 「Node.js のバージョンが違う」
- 「PostgreSQL の設定が異なる」
- macOS では動いたけど、Windows では動かない

これらの問題の主な原因は、**開発環境の違い**です。

Docker を使うことで、**どの環境でも同じように動くアプリケーション**を作り、配布することができます。

---

### 0.2. 事前準備

Docker講習会では事前に以下の環境が整っている前提で進められます。
